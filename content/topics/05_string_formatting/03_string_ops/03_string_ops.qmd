...
🎯 **Test Myself**:Create the string variable `full_name` combining the first and last name. Then, print the following message: _My name is Jose Carlos. I am 19_ (using the variable defined earlier)
```python
first_name = 'Carlos'
last_name = 'Jose'
age = "19"
