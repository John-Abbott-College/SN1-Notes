---
title: "Formatted String __f-string__"
editor:
  render-on-save: true
---

# __f-strings__
Formatted Strings is a powerful way of creating a templated string and inserting variables into specific positions with the created string.
...
An f-string can help us create those generic messages by inserting variables as such:
...
Now try changing the `fist_name` or any of the accounts value. The message template stays the same, but the final printed message changes accordingly. 
