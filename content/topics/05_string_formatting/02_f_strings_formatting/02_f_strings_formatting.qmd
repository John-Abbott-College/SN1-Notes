...
✍️ **Challenge:** You are working on a program used in an ultrasound machine. This device estimates the birth weight of babies and displays it to the screen. The system has a precision of +/- 100mg. Use `f-string` to print the weight with 1 digit after the decimal.
```{pyodide}
weight_birth = 2945.48 #in g

# Complete the f-string
print(f"The Estimated weight {weight } g")
...
print(f"Estimated weight {weight_birth:.5} g")
```
:::
...
✍️ **Challenge:** Print the receipt of the following transaction: price of item1, item2, item3, the subtotal, the tax amount and the total.
...
✍️ **Challenge:** The following transactions appear in your bank statement:
...
print(f"{transaction1:<+10.2f}")
print(f"{transaction2:<+10.2f}")
print(f"{transaction3:<+10.2f}")
print(f"{transaction4:<+10.2f}")
print(f"{transaction5:<+10.2f}")
print(f"{transaction6:<+10.2f}")
```
:::
