...
## Defining functions
The first step in using custom functions is to **define** them. Think of this as teaching Python how to perform some task that your program needs to do. Only after you have defined a function can you **use** it in your program.
...
- An indented instruction or set of instructions (the *body*)  
...
show_message()  # <-- This is how you *use* the function that you defined
```
