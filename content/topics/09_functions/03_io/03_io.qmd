...
![demo](./assets/user_vs_programmer.png)
...
> **Note**: Some teachers may prefer that you always use an f-string instead of combining values with a comma in this style.
