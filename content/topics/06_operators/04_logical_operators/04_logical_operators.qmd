...
🎯 **Test Myself**: *The relative humidity index must be below 100% **AND** the temperature has to be decreasing (negative variation) for it to rain:*
...
🎯 **Test Myself**: *The oil in the car should be changed every 6 months (inclusive) **OR** if the travelled distance **exceeds** 5,000 km*:
```{pyodide}
...
🎯 **Test Myself**: *To return a new sweater you must have the receipt **AND NOT** remove the price tag.*
