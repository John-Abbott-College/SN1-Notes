---
title: "Files & Folders"
subtitle: "Navigating the Windows and Mac filesystems"
editor:
  render-on-save: true
---


::: {.callout-note .objectives icon="false"}
# ☆ Learning Objectives 

- **Understand** what files and folders are
- **Explain** the role of file extensions
- **Identify** common file extensions
- **Navigate** a computer's filesystem
- **Apply** compression and decompression to files and folders
:::
...
![](assets/binary_to_picture.png){width=100%}
...
![](assets/real_file_folders.png){fig-alt="image of paper file folders" width=33%}
...
![](assets/paper_folder_within_folder.png){fig-alt="folders within folders" style="zoom:80%;" width=100% }
...
![](assets/file_explorer.png) {width=100%}
...
![](assets/01_mac_finder.png" alt="MAC Finder symbol){ style="zoom:50%;" }
...
![](assets/01_mac_finder_header.png){ width=100%}

![](assets/01_mac_finder_select.png){ width=100%}

Sometimes (depending on the size of the "finder" window), you may see: Choose one or the other.

![](assets/01_mac_finder_bigger.png){ width=100%}

_List view_

![](assets/01_mac_finder_listview.png){  style="zoom:25%;" }
...
| --------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|           | ![](assets/folder_icon.png){ width="30%"}  | Folders have no extension                                                                                                                                                                         |
| `.docx`   | ![](assets/word_icon.png){ width="30%"}    | Word Document                                                                                                                                                                                     |
| `.py`     | ![](assets/python_icon.png){ width="30%"}  | Python Code                                                                                                                                                                                       |
| `.pdf`    | ![](assets/pdf_icon.png){ width="30%"}    | Portable Document File (PDF) document. Any printer can print this file without having any specialized software.                                                                                   |
| `.csv`    | ![](assets/csv_icon.png){ width="30%"}     | Comma Separated Values (can be read as a text file, or opened with Excel, where Excel will put data into the various columns, where each column data is separated by a comma)                     |
| `.zip`    | ![](assets/zipfile_icon.png){ width="30%"} | Zip file. Contains multiple files within one file. It needs to be `unzipped` before you can use the files within. WARNING: In File Explorer it can look like it is not zipped, even though it is. |
...
![](assets/create_zipfile.png ){ width=80%}
...
![](assets/unzip_files.png){ width=80%}
 ...
 **What to look out for**: - if the folder information ends with a zip file.
 ...
 ![](assets/zipped_file_explorer.png){ width=80%}

 [2DO NOT EVER DOUBLE CLICK A `.py` FILE FROM WITHIN A ZIP FILE. YOUR CHANGES WILL NOT BE SAVED!!]{style="color: red;"}
...
| Name          | Symbol                                                       |
| ------------- | ------------------------------------------------------------ |
| Command       | ![](https://help.apple.com/assets/6716D93AEF41EE42B10D2617/6716D93E49B75650FD0A13E4/en_US/9f928381c28c623497170dc345644f9b.png) |
| Fn (Function) | ![](https://help.apple.com/assets/6716D93AEF41EE42B10D2617/6716D93E49B75650FD0A13E4/en_US/7b00c26c8add24c1d9728d21fbf8869a.png) |
| World         | ![](https://help.apple.com/assets/6716D93AEF41EE42B10D2617/6716D93E49B75650FD0A13E4/en_US/1faa76ae5882af1040a984bf04c1f6ce.png) |
| Option        | ![](https://help.apple.com/assets/6716D93AEF41EE42B10D2617/6716D93E49B75650FD0A13E4/en_US/e9bcb32d2329460fa9262bb80287aeb4.png) |
| Shift         | ![](https://help.apple.com/assets/6716D93AEF41EE42B10D2617/6716D93E49B75650FD0A13E4/en_US/0f795759124f9320650e97ddd0ff4a84.png) |:Mac/Linux Keybaord Keys {tbl-colwidths="[30, 30]"}
...
- Select compress
 ...
 ![](assets/01_mac_finder_to_compress.png){ style="zoom:25%;}

  This will create a file called "Archive.zip"

 ![](assets/01_mac_finder_archive.png){ style="zoom:25%;}
