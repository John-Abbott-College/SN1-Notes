...
The comparison operators are used to determine how two values compare to eachother : _Are these two values equal?_ _Is the first value greater than this second value?_ _Is the first value less than or equal to the second value?_ The result of the operation is a Boolean: `True` or `False`.
